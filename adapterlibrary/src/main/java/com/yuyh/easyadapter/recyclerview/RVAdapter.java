 ...
 * @date 2016/7/21.
 */
public abstract class RVAdapter<T> extends RecyclerView.Adapter<RVHolder> implements DataHelper<T> {
    ...
    public RVAdapter(Context context, List<T> list, int... layoutIds) {
    ...
    public RVHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RVHolder viewHolder = (RVHolder) view.getTag();
        if (viewHolder == null || viewHolder.getLayoutId() != layoutId) {
            viewHolder = new RVHolder(mContext, layoutId, view);
            return viewHolder;
        }
        return viewHolder;
    }
    ...
    protected abstract void onBindData(RVHolder viewHolder, int position, T item);
