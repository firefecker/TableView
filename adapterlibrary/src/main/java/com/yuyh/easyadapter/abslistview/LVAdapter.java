 ...
 * @date 2016/7/21.
 */
public abstract class LVAdapter<T> extends BaseAdapter implements DataHelper<T> {
    ...
    protected LVHolder holder = new LVHolder();

    public LVAdapter(List<T> list, int... layoutIds) {
        this.mList = list;
    ...
    public LVAdapter(Context context,List<T> list, int... layoutIds) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder = holder.get(parent.getContext(), position, convertView, parent, layoutId);
    ...
    public abstract void convert(LVHolder holder, int position, T t);
